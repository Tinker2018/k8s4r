...
public:
    ...
    */
     ...
     * @valid since 3.59
     * @type callback
     * @brief Callback on the media play events. You would receive the notification after calling selectAudioTrack:{@link #ByteRTCMediaPlayer#selectAudioTrack:} and setPosition:{@link #ByteRTCMediaPlayer#setPosition:}.
     * @param player_id ID of the IMediaPlayer{@link #IMediaPlayer}. You can specify the ID via getMediaPlayer:{@link #ByteRTCVideo#getMediaPlayer:}.
