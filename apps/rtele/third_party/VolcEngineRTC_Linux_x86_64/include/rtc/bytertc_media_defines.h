...
enum PublishStateChangeReason {
    ...
    /**
     * @locale en
     * @brief Stream ID validation failed.
     */
...
enum RoomStateChangeReason {
    ...
    /**
     * @locale en
     * @brief Token  is invalid. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged}  callback.<br>
     *        The Token used when calling joinRoom{@link #IRTCRoom#joinRoom} is invalid or expired. The user is required to retrieve the token and call the updateToken{@link #IRTSRoom#updateToken} to update the token.
     */
...
//进房超上限
    ...
    /**
     * @locale en
     * @brief The user has been removed from the room due to the abnormal status of server. This code will be received via onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged}.<br>
    ...
    /**
     * @locale en
     * @brief Join room error. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
...
enum ErrorCode {
    ...
    /**
     * @locale en
     * @brief No permission to publish audio & video streams. Receive message from onVideoPublishStateChanged{@link #IRTCRoomEventHandler#onVideoPublishStateChanged}, onAudioPublishStateChanged{@link #IRTCRoomEventHandler#onAudioPublishStateChanged.<br>
    ...
    /**
     * @locale en
     * @brief No subscription permissions for audio & video streams. Receive message from onVideoSubscribeStateChanged{@link #IRTCRoomEventHandler#onVideoSubscribeStateChanged}, onAudioSubscribeStateChanged{@link #IRTCRoomEventHandler#onAudioSubscribeStateChanged} callback.<br>
    ...
    /**
     * @locale en
     * @brief The user has been removed from the room because the same user joined the room on the other client. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief The user has been removed from the room by the administrator via a OpenAPI call. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief Token expired. This error code is returned when the user's token expires in the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     *        Call joinRoom{@link #IRTCRoom#joinRoom} to rejoin the room with a new required Token.
     */
    ...
    /**
     * @locale en
     * @brief The Token you provided when calling `updateToken` is invalid. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief Users have been removed from the room because the administrator dismissed the room by calling OpenAPI. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @hidden internal use only
     * @brief Join room error. <br>
     *        The LICENSE billing account does not use the LICENSE_AUTHENTICATE SDK while entering the room, which caused the joining room to fail. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief there is a room with the same roomId，whose room id is the same with echo test. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief The local user joins multiple rooms with different uid. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     ...
     * @locale en
     * @hidden internal use only
     * @brief Server license expired, refused to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief Exceeds the upper limit of the concurrency allowed by the server license, and refuses to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief The license parameter is wrong and refuses to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief wrong license certificate path. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief The license certificate is illegal, refuse to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief License certificate has expired, refused to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief The content of the license certificate does not match. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief licenseThe current certificate does not match the cached certificate. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief The room has banned before the user calls `joinRoom`. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief The user has banned before calling `joinRoom`. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
     ...
     * @locale en
     * @hidden internal use only
     * @brief The license method did not load successfully. Check the corresponding extension. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief Subscription to audio & video stream failed, the total number of subscribed audio & video streams exceeded the upper limit. Receive message from onVideoSubscribeStateChanged{@link #IRTCRoomEventHandler#onVideoSubscribeStateChanged}, onAudioSubscribeStateChanged{@link #IRTCRoomEventHandler#onAudioSubscribeStateChanged} callback.<br>
    ...
    /**
     * @locale en
     * @brief Publishing flow failed, the total number of publishing flows exceeds the upper limit. Receive message from Receive message from onVideoPublishStateChanged{@link #IRTCRoomEventHandler#onVideoPublishStateChanged}, onAudioPublishStateChanged{@link #IRTCRoomEventHandler#onAudioPublishStateChanged.<br>
     ...
     * @locale en
     * @deprecated since 3.52, use kErrorCodeOverStreamPublishLimit（-1080）instead
     * @brief The total number of published video streams exceeds the upper limit. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
    ...
    /**
     * @locale en
     * @brief The user has been removed from the room due to the abnormal status of server. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     *        SDK  is disconnected with the signaling server. It will not reconnect automatically. Please contact technical support.
     */
...
enum WarningCode {
    ...
    /**
     * @locale en
     * @brief Failed to enter the room. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     *        When you call the first time to join the room or disconnect and reconnect due to poor network conditions, the room entry fails due to a server error. The SDK automatically retries the room.
     */
    ...
    /**
     * @locale en
     * @brief Release audio & video stream failed.  Receive message from onVideoPublishStateChanged{@link #IRTCRoomEventHandler#onVideoPublishStateChanged}, onAudioPublishStateChanged{@link #IRTCRoomEventHandler#onAudioPublishStateChanged.<br>
    ...
    /**
     * @locale en
     * @brief Subscription to audio & video stream failed.  Receive message from onVideoSubscribeStateChanged{@link #IRTCRoomEventHandler#onVideoSubscribeStateChanged}, onAudioSubscribeStateChanged{@link #IRTCRoomEventHandler#onAudioSubscribeStateChanged} callback.<br>
    ...
    /**
     * @locale en
     * @brief When the number of people in the room exceeds 500, stop sending `onUserJoined` and `onUserLeave` callbacks to existing users in the room, and prompt all users in the room via broadcast. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
    ...
    /**
     * @locale en
     * @brief User had published in other room.  Receive message from onVideoPublishStateChanged{@link #IRTCRoomEventHandler#onVideoPublishStateChanged}, onAudioPublishStateChanged{@link #IRTCRoomEventHandler#onAudioPublishStateChanged.
     */
    ...
    /**
     * @locale en
     * @brief You must call `setScreenAudioSourceType` before calling publishScreenAudio.
     */
    ...
    /**
     * @locale en
     * @brief Setting the audio capture method for screen sharing via `setScreenAudioStreamIndex` after calling publishScreenAudio is not supported.
     */
    ...
    /**
     * @locale en
     * @brief The authentication file is invalid. When checking the status of the authentication file, if the local file is inconsistent with the remote file, a second warning will be triggered. Receive message from onRoomStateChanged{@link #IRTSRoomEventHandler#onRoomStateChanged} callback.<br>
     */
...
public:
     ...
     *         - Use onDecryptData{@link #IEncryptHandler#onDecryptData} to decrypt encrypted audio & video frame data.
