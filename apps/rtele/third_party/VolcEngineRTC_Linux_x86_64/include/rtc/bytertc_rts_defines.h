...
enum LoginErrorCode {
    ...
    /**
     * @locale en
     * @brief An error occurred when calling `login` to log in, try to apply for unlimited rts mode.
     */
 ...
 * @locale en
 * @type keytype
 * @brief Create engine parameters
 */
struct EngineConfig {
    /**
     * @locale zh
    ...
    /**
     * @locale en
     * @brief The unique identifier of each app. Only instances generated with the same app_id can communicate.
     */
    ...
    /**
     * @locale en
     * @brief Please contact the technical support personnel.
     */
    ...
    /**
     * @locale en
     * @brief Custom plugin dynamic library loading directory. Only supported on Android platform.
     */
    ...
    /**
     * @locale en
     * @brief The context of the Android application (Application Context), only supported on Android platform.
     */
    ...
    /**
     * @locale en
     * @brief Whether it is a game scene.
     */
