...
public:
     ...
     * enumerateAudioPlaybackDevices{@link #IAudioDeviceManager#enumerateAudioPlaybackDevices}.
     * @return
     *         - 0: Success
     *         - < 0: Failure
     ...
     * @param device_id Audio capture device ID, available through enumerateAudioCaptureDevices{@link #IAudioDeviceManager#enumerateAudioCaptureDevices}.
