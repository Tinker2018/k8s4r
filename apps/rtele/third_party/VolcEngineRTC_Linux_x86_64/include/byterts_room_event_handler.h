...
public:
    ...
    /**
     * @locale en
     * @deprecated since 3.45 and will be deleted in 3.51, use  instead.
     * @type callback
     * @region Room Management
     ...
     * @param warn Code. See WarningCode{@link #WarningCode}. <br>
     */
     ...
     * @param err Error code. See ErrorCode{@link #ErrorCode}. <br>
     */
     ...
     * @param uid ID of the remote user who enters the room. <br>
     * @param elapsed This parameter is meaningless.
     */
     ...
     * @brief Triggered when you receive a broadcast message from another user in the room.<br>
     * This callback is triggered when another user in the same room calls sendRoomMessage{@link #IRTSRoom#sendRoomMessage}.
     ...
     * @type callback
     * @region Real-time messaging
     * @brief Triggered when you receive a binary broadcast message from another user in the room.<br>
     * This callback is triggered when another user in the same room calls sendRoomBinaryMessage{@link #IRTSRoom#sendRoomBinaryMessage}.
     * @param uid User ID of the message sender.
     * @param size The length of the received binary.
