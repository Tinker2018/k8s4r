...
public:
     ...
     * @type api
     * @list Room Management
     * @brief Create/join a RTS room: create a room when the room does not exist; when the room exists, users who have not joined the room can join the room.   <br>
     ...
     * @param message The broadcast message sent by the user <br>
