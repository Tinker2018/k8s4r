...
public:
     ...
     * @param stats  Reserved parameter, currently empty.
     * @note   <br>
     *        + After the user calls the leaveRoom{@link #IRTSRoom#leaveRoom} method to leave the room, if destroy{@link #IRTSRoom#destroy} is called to destroy the room instance method is called to destroy the RTS engine immediately, this callback event will not be received. <br>
     ...
     * @note Other users in the same room will receive this callback when they call sendRoomMessage{@link #IRTSRoom#sendRoomMessage} to send a broadcast message.
     */
     ...
     * @note Other users in the same room call sendRoomBinaryMessage{@link #IRTSRoom#sendRoomBinaryMessage} Receive this callback when sending a binary broadcast message.
     */
     ...
     * @locale en
     * @type callback
     * @brief > The interface will be deprecated in version 3.64. Please use onUserMessageReceived{@link #IRTSRoomEventHandler#onUserMessageReceived-2} instead.
     ...
     * @note
     *       You must call the sendUserMessage{@link #IRTSRoom#sendUserMessage} method before you can receive the callback.
     * @list Messaging
     */
     ...
     * @locale en
     * @type callback
     * @brief A single user receives a callback (P2P) of binary messages from other uid-owned users in the same room.<br>
     *        > The callback will be deprecated in version 3.64. Please use onUserBinaryMessageReceived{@link #IRTSRoomEventHandler#onUserBinaryMessageReceived-2} instead.
     * @param uid User ID of the message sender.
     ...
     * @note
     *        You must first call the sendUserMessage{@link #IRTSRoom#sendUserMessage} or sendUserBinaryMessage{@link #IRTSRoom#sendUserBinaryMessage} interface to receive this callback.
     * @list Messaging
     */
     ...
     * @locale en
     * @type callback
     * @brief Callback for receiving room messages.<br>
     *        Other users in the same room will receive this callback when they call sendUserMessage{@link #IRTSRoom#sendUserMessage} to send a broadcast message.
     ...
     * @param uid User ID of the message sender.
     * @param message The content of the received binary message..
     * @param size Length of the received binary message.
     * @note Other users in the same room call sendRoomBinaryMessage{@link #IRTSRoom#sendRoomBinaryMessage} Receive this callback when sending a binary broadcast message.
     * @list Messaging
     */
